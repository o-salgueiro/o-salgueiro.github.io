...
window.dict = {
  gl: {
    ...
    "hero.tag":"Tenis como actividade principal","hero.title":"Club de tenis en Paderne (A Coruña)","hero.subtitle":"Benvidos á Sociedad Deportiva O'Salgueiro, club familiar en Paderne (A Coruña), cerca de Betanzos, onde practicar tenis, pádel e natación nunha contorna natural.","hero.cta.tennis":"Ver tenis","hero.cta.contact":"Contactar","hero.cta.review":"Déixanos unha reseña",
    "tennis.title":"Tenis","tennis.facilities.title":"Pistas e instalacións","tennis.facilities.text":"A Sociedad Deportiva O Salgueiro é un club de tenis situado en Paderne (A Coruña), a pocos minutos de Betanzos. Dispón de tres pistas de tenis quick, dúas de elas con iluminación artificial, nunha contorna natural ideal para a práctica deportiva durante todo el año. Fundado en 1975, o club está vinculado desde a súa orixe ao tenis galego e organiza actividades deportivas e sociais para xogadores de todas as idades.",
    ...
    "fees.title":"Tarifas","fees.membership.title":"Cota familiar de socio/a","fees.membership.text":"30€ / mes","fees.note":"",
    "contact.title":"Contacto","contact.name":"Nome","contact.message":"Mensaxe","contact.send":"Enviar","contact.where":"Onde estamos","contact.phone": "Teléfono","contact.map":"Ver en Google Maps","contact.extra":"A 4 km de Betanzos · Horario 24 horas",
  ...
  es: {
    ...
    "hero.tag":"Tenis como actividad principal","hero.title":"Club de tenis en Paderne (A Coruña)","hero.subtitle":"Bienvenidos a la Sociedad Deportiva O'Salgueiro, club familiar en Paderne (A Coruña), cerca de Betanzos, donde practicar tenis, pádel e natación en un entorno natural.","hero.cta.tennis":"Ver tenis","hero.cta.contact":"Contactar","hero.cta.review":"Déjanos una reseña",
    "tennis.title":"Tenis","tennis.facilities.title":"Pistas e instalaciones","tennis.facilities.text":"La Sociedad Deportiva O Salgueiro es un club de tenis situado en Paderne (A Coruña), a pocos minutos de Betanzos. Dispone de tres pistas de tenis quick, dos de ellas con iluminación artificial, en un entorno natural ideal para la práctica deportiva durante todo el año. Fundado en 1975, el club está vinculado desde sus orígenes al tenis gallego y organiza actividades deportivas y sociales para jugadores de todas las edades.",
    ...
    "fees.title":"Tarifas","fees.membership.title":"Cuota familiar de socio","fees.membership.text":"30€ / mes","fees.note":"",
    ...
    "contact.title":"Contacto","contact.name":"Nombre","contact.message":"Mensaje","contact.send":"Enviar","contact.where":"Dónde estamos","contact.phone": "Teléfono","contact.map":"Ver en Google Maps","contact.extra":"A 4 km de Betanzos · Horario 24 horas",
  ...
  en: {
    ...
    "hero.tag":"Tennis as our main activity","hero.title":"Tennis club in Paderne, near Betanzos (A Coruña)","hero.subtitle":"Welcome to Sociedad Deportiva O'Salgueiro, a family club in Paderne (A Coruña), near Betanzos, where you can play tennis, padel, and swim in a natural environment.","hero.cta.tennis":"See tennis","hero.cta.contact":"Contact","hero.cta.review":"Leave us a review",
    "tennis.title":"Tennis","tennis.facilities.title":"Courts & facilities","tennis.facilities.text":"The O Salgueiro Sports Club is a tennis club located in Paderne (A Coruña), just a few minutes from Betanzos.Founded in 1975, the club has more than 50 years of history linked to Galician tennis. Its origin emerged from a group of tennis enthusiasts who ventured to buy land to build the first court.Today, the club features three hard tennis courts, two of them with artificial lighting, in a natural setting ideal for playing sports all year round. Deeply connected to Galician tennis since its origins, O Salgueiro organizes sports and social activities for players of all ages.",
