// i18n dictionary and language handling
const dict = {
  gl: {
  ...
  es: {
    ...
    "fees.title":"Tarifas","fees.membership.title":"Cuota familiar de socio","fees.membership.text":"","fees.note":"","contact.title":"Contacto","contact.name":"Nombre","contact.message":"Mensaje","contact.send":"Enviar","contact.where":"Dónde estamos","contact.map":"Ver en Google Maps","contact.extra":"A 4 km de Betanzos · Horario 24 horas",
